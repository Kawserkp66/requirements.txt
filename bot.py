...
def run():
    # Render এর দেওয়া পোর্ট অথবা লোকাল পোর্ট ৮০৮০ তে রান হবে
...
if __name__ == "__main__":
    # 🌟 এখানে ফ্লাস্ক সার্ভার ব্যাকগ্রাউন্ডে চালু করা হলো, যা Render কে পোর্ট সিগন্যাল পাঠাবে
    keep_alive()
