...
@app.route('/')
def home():
    return "🤖 বট সার্ভার পুরোপুরি সচল!"
...
def call_gemini(payload):
    # গুগল ক্লাউড এপিআই কি-র জন্য ইউনিভার্সাল ইউআরএল গেটওয়ে
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            return f"❌ গুগল সার্ভার রেসপন্স করেনি। (Error Code: {response.status_code})\nআপনার এপিআই কী-তে Generative Language API পারমিশনটি অন আছে কিনা চেক করুন।"
    except Exception as e:
        return f"❌ সংযোগের সময় সমস্যা হয়েছে: {str(e)}"

@bot.message_handler(commands=['start'])
def start(message):
    bot.reply_to(message, "🧠 সুপার ব্রেইন এআই বট সক্রিয় হয়েছে! এখন যেকোনো প্রশ্ন করতে পারেন।")
